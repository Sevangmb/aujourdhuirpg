...
- **Respect des Énumérations (TRÈS IMPORTANT) :**
  - Pour le champ **'type'**, utilisez une des valeurs suivantes : ${ACTION_TYPES.join(', ')}.
  - Pour le champ **'mood'**, utilisez une des valeurs suivantes : ${MOOD_TYPES.join(', ')}.
  - Pour le champ **'iconName'**, utilisez une des valeurs suivantes : ${CHOICE_ICON_NAMES.join(', ')}.
`;
