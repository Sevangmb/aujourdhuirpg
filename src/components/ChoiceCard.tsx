      ...
      <CardHeader className="flex flex-row items-start gap-4 p-4 pb-2">
        ...
        <div>
          ...
          <div className="flex items-center gap-x-3 text-xs opacity-80 mt-1 flex-wrap">
            <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> {choice.timeCost || 0} min</span>
            <span className="flex items-center gap-1"><Zap className="w-3 h-3" /> -{choice.energyCost || 0} Énergie</span>
