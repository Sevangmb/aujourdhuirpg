...
import EvidenceLogDisplay from './EvidenceLogDisplay'; // To be created
  ...
  return (
    <div className="h-full flex flex-col p-1">
      <Tabs defaultValue="inventory" className="w-full flex-grow flex flex-col">
        ...
        <ScrollArea className="flex-grow mt-2 pr-1 min-h-0">
          <TabsContent value="inventory" className="m-0 p-0">
            <InventoryDisplay inventory={player.inventory} />
          </TabsContent>
          <TabsContent value="quests" className="m-0 p-0">
